...
const MThSlash: React.FC<Props> = ({ size = 24, color = 'inherit' }) => {
  const svgElement = new DOMParser().parseFromString(
    <svg
      ...
      viewBox="0 0 24 24"
    >
      <rect width="4" height="4" x="4" y="4" className="uim-quaternary"></rect>
      <rect width="4" height="4" x="10" y="4" className="uim-quaternary"></rect>
      <rect width="4" height="4" x="16" y="4" className="uim-quaternary"></rect>
      <rect
        width="4"
        height="4"
        x="10"
      ...
      ></path>
      <rect width="4" height="4" x="4" y="16" className="uim-quaternary"></rect>
      <rect width="4" height="4" x="4" y="10" className="uim-quaternary"></rect>
    </svg>,
    'image/svg+xml',
  );
