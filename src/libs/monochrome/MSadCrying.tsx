...
const MSadCrying: React.FC<Props> = ({ size = 24, color = 'inherit' }) => {
  const svgElement = new DOMParser().parseFromString(
    ...
    >
      ...
      <path
        ...
        d="M14 14.40564c-1.29102-.47351-2.70898-.47351-4 0v2.21234c1.22363-.77075 2.77637-.77075 4 0V14.40564zM16 11h-2c-.55229 0-1-.44771-1-1s.44771-1 1-1h2c.55228 0 1 .44771 1 1S16.55228 11 16 11zM10 11H8c-.55228 0-1-.44771-1-1s.44772-1 1-1h2c.55229 0 1 .44771 1 1S10.55229 11 10 11z"
      ></path>
    </svg>,
    'image/svg+xml',
  );
