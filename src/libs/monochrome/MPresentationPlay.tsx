...
const MPresentationPlay: React.FC<Props> = ({
  size = 24,
  color = 'inherit',
}) => {
  const svgElement = new DOMParser().parseFromString(
    ...
    >
      ...
      <path
        className="uim-primary"
        d="M7.001 22a1 1 0 0 1-.55274-1.834l5-3.30957a1 1 0 0 1 1.10352 1.668l-5 3.30957A.9945.9945 0 0 1 7.001 22zM10.48975 12.502a1.7631 1.7631 0 0 1-1.7544-1.75781V7.25586a1.75537 1.75537 0 0 1 2.63281-1.51953L14.3877 7.48047a1.755 1.755 0 0 1 0 3.03906l-3.02 1.74414A1.75543 1.75543 0 0 1 10.48975 12.502z"
      ></path>
    </svg>,
    'image/svg+xml',
  );
...
export default MPresentationPlay;
