...
const MEnvelopeDownload: React.FC<Props> = ({
  size = 24,
  color = 'inherit',
}) => {
  const svgElement = new DOMParser().parseFromString(
    ...
    >
      ...
      <path
        className="uim-primary"
        d="M18.5,12c-0.26527,0.0003-0.51971-0.10515-0.707-0.293l-3-3c-0.38694-0.39399-0.38123-1.02706,0.01276-1.414c0.38897-0.38202,1.01227-0.38202,1.40125,0L18.5,9.586l2.293-2.293c0.39399-0.38694,1.02706-0.38123,1.414,0.01275c0.38202,0.38897,0.38202,1.01227,0,1.40125l-3,3C19.01971,11.89485,18.76527,12.0003,18.5,12z"
      ></path>
    </svg>,
    'image/svg+xml',
  );
...
export default MEnvelopeDownload;
