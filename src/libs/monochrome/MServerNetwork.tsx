...
const MServerNetwork: React.FC<Props> = ({ size = 24, color = 'inherit' }) => {
  const svgElement = new DOMParser().parseFromString(
    ...
    >
      ...
      ></path>
      <circle cx="8" cy="5" r="1" className="uim-primary"></circle>
      <circle cx="8" cy="11" r="1" className="uim-primary"></circle>
      <circle cx="12" cy="20" r="2" className="uim-tertiary"></circle>
      <path
        className="uim-primary"
        d="M10 20c0-.36615.10559-.70483.2774-1H3c-.55231 0-1 .44769-1 1s.44769 1 1 1h7.2774C10.10559 20.70483 10 20.36615 10 20zM21 19h-7.2774C13.89441 19.29517 14 19.63385 14 20s-.10559.70483-.2774 1H21c.55231 0 1-.44769 1-1S21.55231 19 21 19zM11 18.2774C11.29517 18.10559 11.63385 18 12 18s.70483.10559 1 .2774V14h-2V18.2774z"
      ></path>
    </svg>,
    'image/svg+xml',
  );
