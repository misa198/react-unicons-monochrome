...
const MPhoneTimes: React.FC<Props> = ({ size = 24, color = 'inherit' }) => {
  const svgElement = new DOMParser().parseFromString(
    ...
    >
      ...
      <path
        ...
        d="M19.84961,5.56445l1.793-1.793a.99989.99989,0,1,0-1.41406-1.41406l-1.793,1.793-1.793-1.793a.99989.99989,0,0,0-1.41406,1.41406l1.793,1.793-1.793,1.793a.99989.99989,0,1,0,1.41406,1.41406l1.793-1.793,1.793,1.793a.99989.99989,0,1,0,1.41406-1.41406Z"
      ></path>
    </svg>,
    'image/svg+xml',
  );
