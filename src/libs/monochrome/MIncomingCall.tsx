...
const MIncomingCall: React.FC<Props> = ({ size = 24, color = 'inherit' }) => {
  const svgElement = new DOMParser().parseFromString(
    ...
    >
      ...
      <path
        ...
        d="M21.64258,2.35742a.99964.99964,0,0,0-1.41406,0l-3.293,3.293V4.06445a1,1,0,0,0-2,0v4a.99973.99973,0,0,0,1,1h4a1,1,0,0,0,0-2H18.34961l3.293-3.293A.99964.99964,0,0,0,21.64258,2.35742Z"
      ></path>
    </svg>,
    'image/svg+xml',
  );
