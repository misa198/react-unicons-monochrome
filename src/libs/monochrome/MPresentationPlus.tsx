...
const MPresentationPlus: React.FC<Props> = ({
  size = 24,
  color = 'inherit',
}) => {
  const svgElement = new DOMParser().parseFromString(
    ...
    >
      ...
      <path
        ...
        d="M14,10H10a1,1,0,0,1,0-2h4a1,1,0,0,1,0,2Z"
      ></path>
      <path
        className="uim-primary"
        d="M12 12a.99943.99943 0 0 1-1-1V7a1 1 0 0 1 2 0v4A.99943.99943 0 0 1 12 12zM21 4H3A1 1 0 0 1 3 2H21a1 1 0 0 1 0 2zM21 16H3a1 1 0 0 1 0-2H21a1 1 0 0 1 0 2z"
      ></path>
      <path
        className="uim-primary"
...
export default MPresentationPlus;
