...
const M12Plus: React.FC<Props> = ({ size = 24, color = 'inherit' }) => {
  const svgElement = new DOMParser().parseFromString(
    ...
    >
      ...
      <path
        className="uim-primary"
        d="M14,13h1a3.00328,3.00328,0,0,0,3-3V9a3.00328,3.00328,0,0,0-3-3H14a3.00328,3.00328,0,0,0-3,3,1,1,0,0,0,2,0,1.00067,1.00067,0,0,1,1-1h1a1.00067,1.00067,0,0,1,1,1v1a1.00067,1.00067,0,0,1-1,1H14a3.00328,3.00328,0,0,0-3,3v3a.99943.99943,0,0,0,1,1h5a1,1,0,0,0,0-2H13V14A1.00067,1.00067,0,0,1,14,13Z"
      ></path>
    </svg>,
    'image/svg+xml',
  );
