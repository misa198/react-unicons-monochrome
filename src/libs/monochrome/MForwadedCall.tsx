...
const MForwadedCall: React.FC<Props> = ({ size = 24, color = 'inherit' }) => {
  const svgElement = new DOMParser().parseFromString(
    ...
    >
      ...
      <path
        ...
        d="M21.64258,4.85742l-2.5-2.5a.99989.99989,0,0,0-1.41406,1.41406l.793.793H14.93555a1,1,0,0,0,0,2h3.58593l-.793.793a.99989.99989,0,1,0,1.41406,1.41406l2.5-2.5A.99964.99964,0,0,0,21.64258,4.85742Z"
      ></path>
    </svg>,
    'image/svg+xml',
  );
