...
const MOutgoingCall: React.FC<Props> = ({ size = 24, color = 'inherit' }) => {
  const svgElement = new DOMParser().parseFromString(
    ...
    >
      ...
      <path
        ...
        d="M20.93555,2.06445h-4a1,1,0,0,0,0,2h1.58593l-3.293,3.293a.99989.99989,0,1,0,1.41406,1.41406l3.293-3.293V7.06445a1,1,0,1,0,2,0v-4A.99974.99974,0,0,0,20.93555,2.06445Z"
      ></path>
    </svg>,
    'image/svg+xml',
  );
