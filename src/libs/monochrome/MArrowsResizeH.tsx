...
const MArrowsResizeH: React.FC<Props> = ({ size = 24, color = 'inherit' }) => {
  const svgElement = new DOMParser().parseFromString(
    ...
    >
      ...
      <path
        ...
        d="M10,18c-0.55197,0.00031-0.99969-0.44689-1-0.99886C9,17.00076,9,17.00038,9,17V7c0-0.55228,0.44771-1,1-1s1,0.44772,1,1v10c0.00031,0.55197-0.44689,0.99969-0.99886,1C10.00076,18,10.00038,18,10,18z M14,18c-0.55197,0.00031-0.99969-0.44689-1-0.99886c0-0.00038,0-0.00076,0-0.00114V7c0-0.55228,0.44771-1,1-1s1,0.44772,1,1v10c0.00031,0.55197-0.44689,0.99969-0.99886,1C14.00076,18,14.00038,18,14,18z"
      ></path>
      <path
        className="uim-primary"
        d="M9 11H3c-.55231 0-1 .44769-1 1s.44769 1 1 1h6V11zM21 11h-6v2h6c.55231 0 1-.44769 1-1S21.55231 11 21 11z"
      ></path>
    </svg>,
    'image/svg+xml',
  );
