...
const MArrowCompressH: React.FC<Props> = ({ size = 24, color = 'inherit' }) => {
  const svgElement = new DOMParser().parseFromString(
    ...
    >
      ...
      <path
        ...
        d="M12,19a.99943.99943,0,0,1-1-1V6a1,1,0,0,1,2,0V18A.99943.99943,0,0,1,12,19Z"
      ></path>
      <path
        className="uim-primary"
      ...
      <path
        className="uim-primary"
        d="M21,13H15a1,1,0,0,1,0-2h6a1,1,0,0,1,0,2Z"
      ></path>
    </svg>,
    'image/svg+xml',
  );
...
export default MArrowCompressH;
